...
export default class ImageInMenu extends Component {
  
  render() {
    
    const { setCurrentCanvasImage, currentCanvasImage, index, deleteImageInMenu } = this.props;
